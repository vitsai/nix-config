...
git_super_status() {
	...
	STATUS="$ZSH_THEME_GIT_PROMPT_PREFIX"
	      ...
	      STATUS="$STATUS$ZSH_THEME_GIT_PROMPT_BRANCH_CLEAN$GIT_BRANCH%{${reset_color}%}"
          else
              STATUS="$STATUS$ZSH_THEME_GIT_PROMPT_BRANCH_DIRTY$GIT_BRANCH$ZSH_THEME_GIT_PROMPT_DIRTY%{${reset_color}%}"
	  fi
